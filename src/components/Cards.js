...
const Cards = ({ data }) => {
  ...
  const [val, setVal] = useState(data.votes);
    ...
    <Container>
      <Row>
        <Col className="center">
          <Image src={data.post_image_url} className="img" />
        </Col>
        ...
        <Col className="center">
          <Card style={changeBorder}>
            <Card.Body>
              <Card.Link href={data.url} target="_blank" rel="noopener">
                {data.title}
              </Card.Link>
              <Card.Text>{data.description}</Card.Text>
              <Card.Subtitle>
                Escrito por:{" "}
                <Image className="avatar" src={data.writer_avatar_url} />
              </Card.Subtitle>
            </Card.Body>
          </Card>
        </Col>
